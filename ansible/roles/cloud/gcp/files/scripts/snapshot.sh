...
###
### Modified  from https://github.com/jacksegal/google-compute-snapshot
###
...
#
# Get and set how long to keep snapshots. Default to 5 (days)
#
...
#
# DELETE OLD SNAPSHOTS (OLDER THAN 5 DAYS)
#
